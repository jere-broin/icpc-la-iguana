...
% Thx Overflowed
% Helicóptero
\def\title{Universidad Nacional de Cordoba - Helicóptero}
.\\[0.2cm]
\centering{\LARGE\textbf{Helicóptero}} \\[0.5cm]
\centering{\includegraphics[width=5.5cm]{img/HÉLICE_COLOR.png}}
...
\cppfile{graphs/rollbackUF.cpp}

\subsection{Dynamic connectivity}
\cppfile{graphs/dynamic_connectivity.cpp}

\subsection{Directed MST (minimum spanning arborescence)}
\cppfile{graphs/directedMST.cpp}
...
\subsection{Virtual Trees}
\cppfile{graphs/virtual_trees.cpp}
...
\subsection{Convex hull reduced}
\cppfile{geometry/reduced_chull.cpp}

\subsection{MEC}
\cppfile{geometry/mec.cpp}
...
\subsection{Record Prime Gaps up to 10\textsuperscript{n}}
\cppfile{other/RecordPrimeGaps.txt}
