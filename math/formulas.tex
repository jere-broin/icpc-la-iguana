...
$\text{Catalan numbers: }C_n=\frac{\binom{2n}{n}}{n+1}=\binom{2n}{n} - \binom{2n}{n+1}$
...
Bolitas en cajitas acotado, $N$ bolitas, $n$ cajitas, $r$ es la cota por cajita.

$\sum_{k=0}^{\lfloor N/(r+1) \rfloor} (-1)^k \binom{n}{k} \binom{N - k(r + 1) + n - 1}{n - 1}$

Catalan's triangle: number of rbs of $n$ pairs with $k$ pairs at depth 0.

$cat(n, k) = \frac{k}{2n - k} \binom{2n - k}{n} = \binom{2n - k - 1}{n - k} - \binom{2n - k - 1}{n - k - 1}$